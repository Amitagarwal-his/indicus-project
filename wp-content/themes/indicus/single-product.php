...
$shadeCard = get_field('shade_card');
$content = get_the_content();
$title = get_the_title();
if ($banner_color || $subheading || $productdownload || $content || $title) :
?>
	<section class="simple-banner sin-prohero <?php if (empty($banner_color)) {
													echo 'empty-prohero';
			...
			<div class="single-pro-inner">
				<div class="sin-protleft">
					<div class="simple-banner-text">
                        ...
                        <?php
						if ($shadeCard) :
							$shadeCardurl = wp_get_attachment_url($shadeCard); ?>
							<a class="elementor-button elementor-button-link elementor-size-sm" href="<?php echo esc_html($shadeCardurl); ?>" target="_blank" style="color: <?php echo $banner_color; ?>">SHADE CARD</a>
						<?php endif; ?>
					</div>
				</div><?php
			...
			<div class="space-row d-flex flex-wrap">
				...
				<div class="flex-50">
					<div class="lspace-content">
						...
						<?php echo $background_description; ?>
